/* ============================================================
   NDMSK Technology — beams-animation.js
   Dynamic 3D Beams Background using Three.js
   ============================================================ */
...
(function () {
    ...
    function initScene() {
        ...
        // --- Material Creation (Ported from React) ---
        function createBeamMaterial(cfg) {
            ...
            const mat = new THREE.ShaderMaterial({
                ...
                vertexShader: `
                    ...
                    ${physical.vertexShader.replace('#include <begin_vertex>', 'transformed.z += getPos(transformed.xyz);')
                        .replace('#include <beginnormal_vertex>', 'objectNormal = getNormal(position.xyz);')}
                `,
                fragmentShader: `
                    uniform float uNoiseIntensity;
                    ${noise}
                    ${physical.fragmentShader.replace('#include <dithering_fragment>', `
            ...
            mat.uniforms.diffuse.value = new THREE.Color(0, 0, 0);
            mat.uniforms.time = { value: 0 };
            mat.uniforms.uSpeed = { value: cfg.speed };
            mat.uniforms.uNoiseIntensity = { value: cfg.noiseIntensity };
            mat.uniforms.uScale = { value: cfg.scale };
            mat.uniforms.roughness = { value: 0.3 };
            mat.uniforms.metalness = { value: 0.3 };
            mat.uniforms.envMapIntensity = { value: 10 };
        ...
        const material = createBeamMaterial(config);
